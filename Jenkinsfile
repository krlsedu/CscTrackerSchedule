...
pipeline {
    ...
    stages {
        ...
        stage('Docker image') {
            ...
            steps {
                sh 'docker build -t krlsedu/csctracker-schedule:' + env.VERSION_NAME + ' -t krlsedu/csctracker-schedule:latest  .'
            }
        }
        stage('Docker Push') {
            agent any
            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'dockerHub', passwordVariable: 'dockerHubPassword', usernameVariable: 'dockerHubUser')]) {
                    ...
                    sh 'docker push krlsedu/csctracker-schedule:' + env.VERSION_NAME
                    sh 'docker push krlsedu/csctracker-schedule'
                }
            }
        }
        ...
        stage('Service update'){
            ...
            steps{
                sh 'docker service update --image krlsedu/csctracker-schedule:' + env.VERSION_NAME + ' csctracker_services_csctrackerSchedule'
            }
        }
    }
}
